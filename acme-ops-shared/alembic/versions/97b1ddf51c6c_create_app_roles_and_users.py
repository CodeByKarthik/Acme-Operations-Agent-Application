...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_app_users_keycloak_user_id'), 'app_users', ['keycloak_user_id'], unique=True)
    op.create_index(op.f('ix_app_users_role_id'), 'app_users', ['role_id'], unique=False)
